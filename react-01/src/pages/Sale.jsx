      ...
      <main>
        ...
        <div className="product-wrapper">
          <div className="flex-container">
            ...
            <section className="col1of3">
              <img className="item-images" src={AirFryer} alt="Air Fryer" />
            </section>
          </div>
        </div>
        ...
        <div className="product-wrapper">
          <div className="flex-container">
            ...
            <section className="col1of3">
              <img className="item-images" src={Brita} alt="Brita Water Filter" />
            </section>
          </div>
        </div>
        ...
        <div className="product-wrapper">
          <div className="flex-container">
            ...
            <section className="col1of3">
              <img className="item-images" src={Table} alt="Vintage Storage Sideboard" />
            </section>
          </div>
        </div>
        ...
        <div className="product-wrapper">
          <div className="flex-container">
            ...
            <section className="col1of3">
              <img className="item-images" src={Backpack} alt="Athletic Trainer Backpack" />
            </section>
          </div>
        </div>
      </main>
